            ...
            <div class="card">
                ...
                <div class="card-header">
                    <div class="card-title">
                        <button class="btn-default btn-sm" type="button" onclick="window.location.href='{{ route('sub-categories.index') }}'">Reset</button>
                    </div>
                ...
                <div class="card-body table-responsive p-0">								
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            @if ($sabCategories->isNotEmpty())
                            @foreach ($sabCategories as $subCategory)
                            <tr>
